...
#define  ZINT_VERSION  "zint_v1.00.00"
...
ZINT_EXTERN int ZBarcode_EncodeExt(struct zint_symbol *symbol, uint8_t *input, int length);
ZINT_EXTERN int ZBarcode_GetCodeData(struct zint_symbol *symbol, uint8_t *pCodeData, int *pRows, int *pCols);
