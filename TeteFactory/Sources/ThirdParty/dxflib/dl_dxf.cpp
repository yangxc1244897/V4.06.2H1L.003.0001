 ...
 */
bool CDxfReader::in(const std::string& file, DL_CreationInterface* creationInterface) {
    FILE *fp;
    firstCall = true;
    currentObjectType = DL_UNKNOWN;

    errno_t err = fopen_s(&fp,file.c_str(), "rt");
    if (!err) {
 ...
 * @retval false If \p file could not be opened.
 */
bool CDxfReader::in(std::stringstream& stream,
 ...
 */
bool CDxfReader::readDxfGroups(FILE *fp, DL_CreationInterface* creationInterface) {

    static int line = 1;

    // Read one group of the DXF file and strip the lines:
    if (CDxfReader::getStrippedLine(groupCodeTmp, DL_DXF_MAXLINE, fp) &&
        CDxfReader::getStrippedLine(groupValue, DL_DXF_MAXLINE, fp, false) ) {
 ...
 */
bool CDxfReader::readDxfGroups(std::stringstream& stream,
                           DL_CreationInterface* creationInterface) {

    static int line = 1;

    // Read one group of the DXF file and chop the lines:
    if (CDxfReader::getStrippedLine(groupCodeTmp, DL_DXF_MAXLINE, stream) &&
        CDxfReader::getStrippedLine(groupValue, DL_DXF_MAXLINE, stream, false) ) {
 ...
 */
bool CDxfReader::getStrippedLine(std::string& s, unsigned int size, FILE *fp, bool stripSpace) {
    if (!feof(fp)) {
 ...
 * Same as above but for stringstreams.
 */
bool CDxfReader::getStrippedLine(std::string &s, unsigned int size,
 ...
 */
bool CDxfReader::stripWhiteSpace(char** s, bool stripSpace) {
    // last non-NULL char:
...
*/
bool CDxfReader::processDXFGroup(DL_CreationInterface* creationInterface,
 ...
 */
void CDxfReader::addComment(DL_CreationInterface* creationInterface, const std::string& comment) {
    creationInterface->addComment(comment);
}

void CDxfReader::addDictionary(DL_CreationInterface* creationInterface) {
    creationInterface->addDictionary(DL_DictionaryData(getStringValue(5, "")));
}

void CDxfReader::addDictionaryEntry(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addSetting(DL_CreationInterface* creationInterface) {
    int c = -1;
 ...
 */
void CDxfReader::addLayer(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addLinetype(DL_CreationInterface* creationInterface) {
    std::string name = getStringValue(2, "");
    if (name.length()==0) {
        return;
    }
 ...
 */
bool CDxfReader::handleLinetypeData(DL_CreationInterface* creationInterface) {
    if (groupCode == 49) {
 ...
 */
void CDxfReader::addBlock(DL_CreationInterface* creationInterface) {
    std::string name = getStringValue(2, "");
    if (name.length()==0) {
        return;
    }
 ...
 */
void CDxfReader::endBlock(DL_CreationInterface* creationInterface) {
    creationInterface->endBlock();
}
void CDxfReader::addTextStyle(DL_CreationInterface* creationInterface) {
    std::string name = getStringValue(2, "");
    if (name.length()==0) {
        return;
    }
 ...
 */
void CDxfReader::addPoint(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addLine(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addXLine(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addRay(DL_CreationInterface* creationInterface) {
...
/**
 * @fn  void CDxfReader::addPolyline(DL_CreationInterface* creationInterface)
 *
 * @brief   Adds a polyline entity that was read from the file via the creation interface.
 *
 * @date    2017/8/1
 *
 * @param [in,out]  creationInterface   If non-null, the creation interface.
 */

void CDxfReader::addPolyline(DL_CreationInterface* creationInterface)
{
    ...
    maxVertices = maxVertices<(vertexIndex + 1) ? maxVertices : (vertexIndex+1);

    if (currentObjectType==DL_ENTITY_LWPOLYLINE) 
    {
        for (int i=0; i<maxVertices; i++) 
        {
            DL_VertexData d(vertices[i*4],vertices[i*4+1],vertices[i*4+2],vertices[i*4+3]);
 ...
 */
void CDxfReader::addVertex(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addSpline(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addArc(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addCircle(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addEllipse(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addInsert(DL_CreationInterface* creationInterface) {
    //printf("addInsert\n");
    //printf("code 50: %s\n", values[50]);
 ...
 * @author AHM
 */
void CDxfReader::addTrace(DL_CreationInterface* creationInterface) {
    DL_TraceData td;
 ...
 */
void CDxfReader::add3dFace(DL_CreationInterface* creationInterface) {
    DL_3dFaceData td;
 ...
 * @author AHM
 */
void CDxfReader::addSolid(DL_CreationInterface* creationInterface) {
    DL_SolidData sd;
 ...
 */
void CDxfReader::addMText(DL_CreationInterface* creationInterface) {
    double angle = 0.0;
 ...
 */
bool CDxfReader::handleXRecordData(DL_CreationInterface* creationInterface) {
    if (groupCode==105) {
        return false;
    }
 ...
 */
bool CDxfReader::handleDictionaryData(DL_CreationInterface* creationInterface) {
    if (groupCode==3) {
        return true;
    }
 ...
 */
bool CDxfReader::handleXData(DL_CreationInterface* creationInterface) {
    if (groupCode==1001) {
 ...
 */
bool CDxfReader::handleMTextData(DL_CreationInterface* creationInterface) {
 ...
 */
bool CDxfReader::handleLWPolylineData(DL_CreationInterface* /*creationInterface*/) {
 ...
 */
bool CDxfReader::handleSplineData(DL_CreationInterface* /*creationInterface*/) {
 ...
 */
bool CDxfReader::handleLeaderData(DL_CreationInterface* /*creationInterface*/) {
 ...
 */
void CDxfReader::addText(DL_CreationInterface* creationInterface) {
    DL_TextData d(
        // insertion point
        getRealValue(10, 0.0),
        getRealValue(20, 0.0),
 ...
 */
void CDxfReader::addArcAlignedText(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addAttribute(DL_CreationInterface* creationInterface) {
    DL_AttributeData d(
        // insertion point
        getRealValue(10, 0.0),
        getRealValue(20, 0.0),
 ...
 */
DL_DimensionData CDxfReader::getDimData() {
 ...
 */
void CDxfReader::addDimLinear(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addDimAligned(DL_CreationInterface* creationInterface) {
    DL_DimensionData d = getDimData();
 ...
 */
void CDxfReader::addDimRadial(DL_CreationInterface* creationInterface) {
    DL_DimensionData d = getDimData();
 ...
 */
void CDxfReader::addDimDiametric(DL_CreationInterface* creationInterface) {
    DL_DimensionData d = getDimData();
 ...
 */
void CDxfReader::addDimAngular(DL_CreationInterface* creationInterface) {
    DL_DimensionData d = getDimData();
 ...
 * Adds an angular dimension entity that was read from the file via the creation interface.
 */
void CDxfReader::addDimAngular3P(DL_CreationInterface* creationInterface) {
    DL_DimensionData d = getDimData();
 ...
 */
void CDxfReader::addDimOrdinate(DL_CreationInterface* creationInterface) {
    DL_DimensionData d = getDimData();
 ...
 */
void CDxfReader::addLeader(DL_CreationInterface* creationInterface) {
    // leader (arrow)
    DL_LeaderData le(
        // arrow head flag
        getIntValue(71, 1),
 ...
 */
void CDxfReader::addHatch(DL_CreationInterface* creationInterface) {
...
void CDxfReader::addHatchLoop() {
    addHatchEdge();
    hatchEdges.push_back(std::vector<DL_HatchEdgeData>());
}

void CDxfReader::addHatchEdge() {
 ...
 */
bool CDxfReader::handleHatchData(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addImage(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::addImageDef(DL_CreationInterface* creationInterface) {
 ...
 */
void CDxfReader::endEntity(DL_CreationInterface* creationInterface) {
    creationInterface->endEntity();
}
 ...
 */
void CDxfReader::endSequence(DL_CreationInterface* creationInterface) {
 ...
 */
//int CDxfReader::stringToInt(const char* s, bool* ok) {
//    if (ok!=NULL) {
//        // check string:
//        *ok = true;
//        int i=0;
 ...
 */
DL_WriterA* CDxfReader::out(const char* file, DL_Codes::version version) {
 ...
 */
void CDxfReader::writeHeader(DL_WriterA& dw) {
 ...
 */
void CDxfReader::writePoint(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeLine(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeXLine(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeRay(DL_WriterA& dw,
 ...
 * @see writeVertex
 */
void CDxfReader::writePolyline(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeVertex(DL_WriterA& dw,
 ...
 */
void CDxfReader::writePolylineEnd(DL_WriterA& dw) {
    if (version==DL_VERSION_2000) {
    } else {
        dw.entity("SEQEND");
    }
 ...
 */
void CDxfReader::writeSpline(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeControlPoint(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeFitPoint(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeKnot(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeCircle(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeArc(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeEllipse(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeSolid(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeTrace(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::write3dFace(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeInsert(DL_WriterA& dw,
                         const DL_InsertData& data,
                         const DL_Attributes& attrib) {

    if (data.name.empty()) {
        std::cerr << "CDxfReader::writeInsert: "
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeMText(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeText(DL_WriterA& dw,
...
void CDxfReader::writeAttribute(DL_WriterA& dw,
...
void CDxfReader::writeDimStyleOverrides(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimAligned(DL_WriterA& dw,
                             const DL_DimensionData& data,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimLinear(DL_WriterA& dw,
                            const DL_DimensionData& data,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimRadial(DL_WriterA& dw,
                            const DL_DimensionData& data,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimDiametric(DL_WriterA& dw,
                               const DL_DimensionData& data,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimAngular(DL_WriterA& dw,
                             const DL_DimensionData& data,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimAngular3P(DL_WriterA& dw,
                               const DL_DimensionData& data,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeDimOrdinate(DL_WriterA& dw,
                             const DL_DimensionData& data,
 ...
 * @see writeVertex
 */
void CDxfReader::writeLeader(DL_WriterA& dw,
 ...
 */
void CDxfReader::writeLeaderVertex(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeHatch1(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeHatch2(DL_WriterA& dw,
                         const DL_HatchData& data,
                         const DL_Attributes& /*attrib*/) {
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeHatchLoop1(DL_WriterA& dw,
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeHatchLoop2(DL_WriterA& dw,
                             const DL_HatchLoopData& /*data*/) {
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeHatchEdge(DL_WriterA& dw,
 ...
 */
int CDxfReader::writeImage(DL_WriterA& dw,
                       const DL_ImageData& data,
                       const DL_Attributes& attrib) {

    /*if (data.file.empty()) {
        std::cerr << "CDxfReader::writeImage: "
 ...
 */
void CDxfReader::writeImageDef(DL_WriterA& dw,
                           int handle,
                           const DL_ImageData& data) {
 ...
 * @param attrib Attributes
 */
void CDxfReader::writeLayer(DL_WriterA& dw,
                        const DL_LayerData& data,
                        const DL_Attributes& attrib) {

    if (data.name.empty()) {
        std::cerr << "CDxfReader::writeLayer: "
 ...
 * tables section of a DXF file.
 */
void CDxfReader::writeLinetype(DL_WriterA& dw,
    ...
    if (data.name.empty()) {
        std::cerr << "CDxfReader::writeLinetype: "
 ...
 */
void CDxfReader::writeAppid(DL_WriterA& dw, const std::string& name) {
    if (name.empty()) {
        std::cerr << "CDxfReader::writeAppid: "
 ...
 */
void CDxfReader::writeBlock(DL_WriterA& dw, const DL_BlockData& data) {
    if (data.name.empty()) {
        std::cerr << "CDxfReader::writeBlock: "
        << "Block name must not be empty\n";
        return;
    }
 ...
 */
void CDxfReader::writeEndBlock(DL_WriterA& dw, const std::string& name) {
    std::string n = name;
    std::transform(n.begin(), n.end(), n.begin(), ::toupper);
 ...
 */
void CDxfReader::writeVPort(DL_WriterA& dw) {
 ...
 */
void CDxfReader::writeStyle(DL_WriterA& dw, const DL_StyleData& style) {
//    dw.dxfString(  0, "TABLE");
 ...
 * to make the file readable by Aut*cad.
 */
void CDxfReader::writeView(DL_WriterA& dw) {
    dw.dxfString(  0, "TABLE");
    dw.dxfString(  2, "VIEW");
    if (version==DL_VERSION_2000) {
        dw.dxfHex(5, 6);
 ...
 * to make the file readable by Aut*cad.
 */
void CDxfReader::writeUcs(DL_WriterA& dw) {
    dw.dxfString(  0, "TABLE");
    dw.dxfString(  2, "UCS");
    if (version==DL_VERSION_2000) {
        dw.dxfHex(5, 7);
 ...
 * to make the file readable by Aut*cad.
 */
void CDxfReader::writeDimStyle(DL_WriterA& dw,
 ...
 * to make the file readable by Aut*cad.
 */
void CDxfReader::writeBlockRecord(DL_WriterA& dw) {
    dw.dxfString(  0, "TABLE");
 ...
 */
void CDxfReader::writeBlockRecord(DL_WriterA& dw, const std::string& name) {
    dw.dxfString(  0, "BLOCK_RECORD");
    if (version==DL_VERSION_2000) {
        dw.handle();
    }
 ...
 * to make the file readable by Aut*cad.
 */
void CDxfReader::writeObjects(DL_WriterA& dw, const std::string& appDictionaryName) {
...
void CDxfReader::writeAppDictionary(DL_WriterA& dw) {
    dw.dxfString(  0, "DICTIONARY");
    //dw.handle();
...
int CDxfReader::writeDictionaryEntry(DL_WriterA& dw, const std::string& name) {
    dw.dxfString(  3, name);
...
void CDxfReader::writeXRecord(DL_WriterA& dw, int handle, int value) {
...
void CDxfReader::writeXRecord(DL_WriterA& dw, int handle, double value) {
    dw.dxfString(  0, "XRECORD");
    dw.dxfHex(5, handle);
    dw.dxfHex(330, appDictionaryHandle);
    dw.dxfString(100, "AcDbXrecord");
...
void CDxfReader::writeXRecord(DL_WriterA& dw, int handle, bool value) {
    dw.dxfString(  0, "XRECORD");
    dw.dxfHex(5, handle);
    dw.dxfHex(330, appDictionaryHandle);
    dw.dxfString(100, "AcDbXrecord");
...
void CDxfReader::writeXRecord(DL_WriterA& dw, int handle, const std::string& value) {
    dw.dxfString(  0, "XRECORD");
    dw.dxfHex(5, handle);
    dw.dxfHex(330, appDictionaryHandle);
    dw.dxfString(100, "AcDbXrecord");
 ...
 * to make the file readable by Aut*cad.
 */
void CDxfReader::writeObjectsEnd(DL_WriterA& dw) {
 ...
 */
void CDxfReader::writeComment(DL_WriterA& dw, const std::string& comment) {
 ...
 */
bool CDxfReader::checkVariable(const char* var, DL_Codes::version version) {
    if (version>=DL_VERSION_2000) {
        return true;
 ...
 */
int CDxfReader::getLibVersion(const std::string& str) {
    int d[4];
    int idx = 0;
    //char v[4][5];
    std::string v[4];
    ...
    if (idx>=2) {
        ...
        std::cerr << "CDxfReader::getLibVersion: invalid version number: " << str << "\n";
        return 0;
    }
}
 ...
 */
//double CDxfReader::toReal(const char* value, double def) {
